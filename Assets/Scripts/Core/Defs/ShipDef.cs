...
public class Placement
{
    ...
    /// <summary>탄약고 잔량 비율. 탄약고가 아니면 1.</summary>
    public float rounds = 1f;
...
public class ShipDef
{
    ...
    /// 그 배수가 아니면 비가 안 떨어져 판마다 리샘플 오차가 남고, 증상은 판 경계마다 생기는
    /// 이음매다. 48은 ArmorSkin과 1:1이라 그 리샘플 자체가 없다 - 가장 안전한 값.
    /// </summary>
